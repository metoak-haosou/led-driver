...
//打开文件函数
static int
open_led1(struct inode *inode, struct file *fp)
{
...
//关闭文件函数
static int
release_led1(struct inode *inode, struct file *fp)
{
...
//读函数
static ssize_t
read_led1 (struct file *fp, char __user *ubuf, size_t count, loff_t *ppos)
{
...
//写函数
static ssize_t
write_led1 (struct file *fp, const char __user *ubuf, size_t count, loff_t *ppos)
{
	printk(KERN_NOTICE"write\n");
	return 0;
}
//文件操作函数集
static struct file_operations fops_led1={
	.owner = THIS_MODULE,
	.open = open_led1,
	.release = release_led1,
	.read = read_led1,
	.write = write_led1,
};
