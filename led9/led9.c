...
static int
open_led9(struct inode *inode, struct file *fp)
{
...
//关闭文件函数
static int
release_led9(struct inode *inode, struct file *fp)
{
...
//读函数
static ssize_t
read_led9 (struct file *fp, char __user *ubuf, size_t count, loff_t *ppos)
{
...
//写函数
static ssize_t
write_led9 (struct file *fp, const char __user *ubuf, size_t count, loff_t *ppos)
{
...
//文件操作函数集
static struct file_operations fops_led9={
	.owner = THIS_MODULE,
	.open = open_led9,
	.release = release_led9,
	.read = read_led9,
	.write = write_led9,
